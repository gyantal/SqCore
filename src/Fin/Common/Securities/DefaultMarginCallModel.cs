...
namespace QuantConnect.Securities
{
    ...
    public class DefaultMarginCallModel : IMarginCallModel
    {
        ...
        protected virtual SubmitOrderRequest GenerateMarginCallOrder(Security security, decimal totalPortfolioValue, decimal totalUsedMargin)
        {
            ...
            // SqCore Change NEW:
            return new SubmitOrderRequest(OrderType.Market, security.Type, security.Symbol, quantity, 0, 0, 0, security.LocalTime.ConvertToUtc(security.Exchange.TimeZone), "Margin Call", DefaultOrderProperties?.Clone());
            // SqCore Change END
        }
