...
namespace QuantConnect.Parameters
{
    ...
    public class SqBacktestConfig
    {
        ...
        public static bool SqDailyTradingAtMOC { get; set; } = true; // True: we try to push daily data and trade at 16:00ET. False: QC original: daily data is pushed and trade at 00:00 next day or Per Minute data is pushed when it occured.
        ...
        // Sampling refers that the BacktestingResultHandler.ProcessSynchronousEvents() run periodically (daily) in the main loop and creates the result 'Charts' OR our favoured RawPv or TwrPv lists.
        public bool SamplingQcOriginal { get; set; } = false; // this generates the usual QC Charts. Supports daily or per minute resolution
        ...
        public bool SamplingSqDailyTwrPv { get; set; } = true; // by default we only need the TWR PV (not the rawPV) for calculating proper maxDD, Sharpe etc.
        public bool SamplingSqDailyRawPv { get; set; } = true;
