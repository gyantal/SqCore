...
namespace QuantConnect
{
    ...
    public static class SymbolRepresentation
    {
        ...
        public static Symbol ParseFutureSymbol(string ticker, int? futureYear = null)
        {
            ...
            {
                Utils.Logger.Debug($"SymbolRepresentation.ParseFutureSymbol(): Failed to get market for future '{ticker}' and underlying '{underlying}'");
                return null;
            }
        ...
        public static Symbol ParseFutureOptionSymbol(string ticker, int strikeScale = 1)
        {
            ...
            {
                Utils.Logger.Debug($"SymbolRepresentation.ParseFutureOptionSymbol(): No market found for '{futureTicker}'");
                return null;
            }
