...
namespace QuantConnect
{
    ...
    public static class Time
    {
        ...
        public static DateTime UnixTimeStampToDateTime(double unixTimeStamp)
        {
            ...
            {
                Utils.Logger.Error(err, Invariant($"UnixTimeStamp: {unixTimeStamp}"));
                time = DateTime.Now;
            }
            return time;
        }
        ...
        public static double DateTimeToUnixTimeStamp(DateTime time)
        {
            ...
            {
                Utils.Logger.Error(err, Invariant($"{time:o}"));
            }
            return timestamp;
        }
        ...
        {
            var count = 0;
            Utils.Logger.Trace(Invariant($"Time.TradeableDates(): Security Count: {securities.Count}"));
            try
            {
