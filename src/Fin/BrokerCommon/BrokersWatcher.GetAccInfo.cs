...
public class BrAccPos
{
    ...
    public double Position { get; set; } // in theory, position is Int (whole number) for all the examples I seen. However, IB gives back as decimal, just in case of a complex contract. Be prepared.
