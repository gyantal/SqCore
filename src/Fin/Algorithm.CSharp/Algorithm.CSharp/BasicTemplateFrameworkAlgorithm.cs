...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void Initialize()
        {
            ...
            // SqCore Change NEW:
            SetUniverseSelection(new ManualUniverseSelectionModel(QuantConnect.Symbol.Create("SPY-QC", SecurityType.Equity, Market.USA)));
            // SqCore Change END
        ...
        {
            Debug($"BasicTemplateFrameworkAlgorithm.OnOrderEvent(). {orderEvent.ToString()}");
