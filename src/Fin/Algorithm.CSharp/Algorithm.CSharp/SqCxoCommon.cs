...
namespace QuantConnect.Algorithm.CSharp
{
    public class SqCxoCommon
    {
        ...
        public static Dictionary<DateTime, Dictionary<string, decimal>> AllocationByMonth()
        {
            ...
            {
                { new DateTime(2024, 11, 30 ), new Dictionary<string, decimal> { { "TLT", 0.0m }, { "LQD", 0.0m }, { "SPY", 0.0m }, { "CASH", 1.0m } } },
                { new DateTime(2024, 10, 31 ), new Dictionary<string, decimal> { { "TLT", 0.0m }, { "LQD", 0.0m }, { "SPY", 0.0m }, { "CASH", 1.0m } } },
