...
namespace QuantConnect.Lean.Engine.Results
{
    ...
    public abstract class BaseResultsHandler
    {
        ...
        private readonly TextWriter StandardOut = Console.Out;
        private readonly TextWriter StandardError = Console.Error;
        ...
        /// </summary>
        public List<LogEntry> LogStore { get; }
        ...
        protected virtual void SamplePerformance(DateTime time, decimal value)
        {
            ...
            {
                Utils.Logger.Debug("BaseResultsHandler.SamplePerformance(): " + time.ToShortTimeString() + " >" + value);
            }
            ...
            SortedDictionary<DateTime, decimal> profitLoss = null, CapacityEstimate estimatedStrategyCapacity = null)
        {
            ...
            {
                Utils.Logger.Error(err, "BaseResultsHandler.GenerateStatisticsResults(): Error generating statistics packet");
            }
