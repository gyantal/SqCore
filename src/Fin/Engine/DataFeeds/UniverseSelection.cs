        ...
        public SecurityChanges ApplyUniverseSelection(Universe universe, DateTime dateTimeUtc, BaseDataCollection universeData)
        {
            ...
            foreach (var symbol in selections)
            {
                                                                         ...
                                                                         _algorithm.SubscriptionManager.SubscriptionDataConfigService))
                {
                    ...
                    if (toRemove != null)
                    {
                        Utils.Logger.Trace($"UniverseSelection.ApplyUniverseSelection(): Removing internal currency data feed {toRemove}");
            ...
            if (securityChanges != SecurityChanges.None && Utils.Logger.DebuggingEnabled())
            {
                ...
                Utils.Logger.Debug("UniverseSelection.ApplyUniverseSelection(): " + dateTimeUtc + ": " + securityChanges);
            }
            ...
            if (!_initializedSecurityBenchmark)
            {
                ...
                if (securityBenchmark != null)
                {
                    ...
                    if (dataConfig != null)
                    {
                        ...
                        Utils.Logger.Trace($"UniverseSelection.AddPendingInternalDataFeeds(): Adding internal benchmark data feed {dataConfig}");
                    }
                }
            }
