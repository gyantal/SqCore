...
namespace QuantConnect.Lean.Engine
{
    ...
    public class AlgorithmTimeLimitManager : IIsolatorLimitResultProvider
    {
        ...
        public void RequestAdditionalTime(int minutes)
        {
            ...
            {
                _failed = true;
                Utils.Logger.Debug($"AlgorithmTimeLimitManager.RequestAdditionalTime({minutes}): Failed to acquire additional time. Marking failed.");
            }
        }
        ...
        {
            Utils.Logger.Debug($"AlgorithmTimeLimitManager.TryRequestAdditionalTime({minutes}): Requesting additional time. Available: {AdditionalTimeBucket.AvailableTokens}");
            ...
            if (AdditionalTimeBucket.TryConsume(minutes))
            {
                ...
                Utils.Logger.Debug($"AlgorithmTimeLimitManager.TryRequestAdditionalTime({minutes}): Success: AdditionalMinutes: {newValue}");
                return true;
            }
