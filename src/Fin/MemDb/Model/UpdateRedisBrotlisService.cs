...
public class UpdateRedisBrotlisService
{
    ...
    public static void Update(UpdateBrotliParam brotliParam)
    {
        _ = brotliParam; // StyleCop SA1313 ParameterNamesMustBeginWithLowerCaseLetter. They won't fix. Recommended solution for unused parameters, instead of the discard (_1) parameters
