...
function choseall(nameS) {
  const x = document.getElementsByName(nameS);
  let y = 0;
  for (let i = 0; i < x.length; i++) {
    if ((document.getElementsByName(nameS) as unknown as HTMLInputElement)[i].checked)
      y += 1;
  }
  for (let i = 0; i < x.length; i++) {
    if (y == x.length) {
      (document.getElementsByName(nameS) as unknown as HTMLInputElement)[i].checked = true;
      (document.getElementsByName(nameS) as unknown as HTMLInputElement)[i].click();
    } else {
      if ((document.getElementsByName(nameS) as unknown as HTMLInputElement)[i].checked != true) {
        (document.getElementsByName(nameS) as unknown as HTMLInputElement)[i].checked = false;
        (document.getElementsByName(nameS) as unknown as HTMLInputElement)[i].click();
      }
    }
  }
...
function checkAll(ele) {
  const x = document.getElementsByClassName('szpari');
  let y = 0;
  for (let i = 0; i < x.length; i++) {
    if ((x as unknown as HTMLInputElement)[i].checked)
      y += 1;
  }
  for (let i = 0; i < x.length; i++) {
    if (y == x.length) {
      (x as unknown as HTMLInputElement)[i].checked = true;
      (document.getElementsByClassName('szpari')as unknown as HTMLInputElement)[i].click();
    } else {
      if ((x as unknown as HTMLInputElement)[i].checked != true) {
        (x as unknown as HTMLInputElement)[i].checked = false;
        (document.getElementsByClassName('szpari')as unknown as HTMLInputElement)[i].click();
      }
    }
  }
...
console.log(checkAll, choseall, getQueryVariable);
