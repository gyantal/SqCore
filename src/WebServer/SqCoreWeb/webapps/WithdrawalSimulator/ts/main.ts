...
function simulationDriverFunction(): any {
...
simulateBtn.onclick = function() { simulationDriverFunction(); };

// simulateBtn.onclick = (() => simulationDriverFunction());
// console.log('The function', simulationDriverFunction());
// setInterval(() => { simulationDriverFunction(); }, 60 * 1000);
