...
public class WebsitesMonitorExecution : SqExecution
{
    ...
    {
        Utils.Logger.Warn($"CheckSpIndexChanges(). 2024-10-15: spglobal.com changed again its website structure. This is not important feature. We don't fix it until it becomes needed.");
        // 2024-10-15: spglobal.com changed its website structure. Now, it is not possible to get the index changes directly from https://www.spglobal.com/spdji/en/indices/equity/sp-500/
        // now it is downloaded in the browser with a separate data query:
        // https://www.spglobal.com/spdji/en/util/redesign/index-specialization-ri-solr-json.dot?indexFamily=equity--us-equity--us-market-cap&pageNumber=1&date=all&language_id=1&_=1729028618864
        // https://www.spglobal.com/spdji/en/util/redesign/index/get-index-page-index-news-announcement-json.dot?indexId=340&indexSpecialization=marketCap&language_id=1&_=1729028618865
        // The first one is complicated data, the second one is "Unauthorized access" without the Cookie.
        // As this is not an important service, we will skip this feature for now.
        return;
