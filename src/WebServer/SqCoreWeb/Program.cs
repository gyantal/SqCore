    ...
    public static string DisplaySubMenuAndExecute_BacktesterAdmin()
    {
        ...
        switch (userInput)
        {
            ...
            case "3":
                ...
                // backtestResults = Backtester.BacktestInSeparateThreadWithTimeout("SqTradeAccumulation", "startDate=2002-07-29&endDate=now&startDateAutoCalcMode=WhenFirstTickerAlive&assets=SPY,TLT&weights=60,40&rebFreq=Daily,30d",
                //    [new Trade() { Id = 0, AssetType = AssetType.Stock, Action = TradeAction.Buy, Symbol = "TSLA", Price = 100, Quantity = 87, Time = new DateTime(2022, 09, 01) }, new Trade() { Id = 1, AssetType = AssetType.Stock, Action = TradeAction.Sell, Symbol = "TSLA", Price = 200, Quantity = 87, Time = new DateTime(2023, 08, 31) }], @"{""ema-fast"":10,""ema-slow"":20}", SqResult.SqSimple); // testing sending TradeHist input
