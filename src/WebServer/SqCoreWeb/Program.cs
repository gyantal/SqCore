    ...
    public static string DisplaySubMenuAndExecute_BacktesterAdmin()
    {
        ...
        switch (userInput)
        {
            ...
            case "3":
                ...
                // backtestResults = Backtester.BacktestInSeparateThreadWithTimeout("SqCxoMomentum", "startDate=2009-01-05&endDate=now&assets=SPY,DBC,EMB,EFA,GLD,IWM,TLT,VNQ&lookback=84&noETFs=3", null, @"{""ema-fast"":10,""ema-slow"":20}", backtestConfig);
