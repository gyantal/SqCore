...
export class AppComponent {
  ...
  constructor(http: HttpClient) {
    ...
    this.m_controllerBaseUrl = window.location.origin + '/LlmAssistant/'; // window.location.origin (URL without the path) = Local: "https://127.0.0.1:4206", Server: https://sqcore.net"
