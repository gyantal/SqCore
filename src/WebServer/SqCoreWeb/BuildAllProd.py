...
os.system("ng build MarketDashboard --configuration production --base-href ./")
os.system("ng build HealthMonitor --configuration production --base-href ./")
os.system("ng build PortfolioViewer --configuration production --base-href ./")
os.system("ng build ChartGenerator --configuration production --base-href ./")
os.system("ng build TechnicalAnalyzer --configuration production --base-href ./")
os.system("ng build LlmAssistant --configuration production --base-href ./")
