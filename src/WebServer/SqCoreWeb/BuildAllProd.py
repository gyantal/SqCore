...
if os.path.exists("bin/Release/net5.0/publish"):
    shutil.rmtree("bin/Release/net5.0/publish")    # platform independent way of deleting a folder recursively
...
with fileinput.FileInput("bin/Release/net5.0/publish/NLog.config", inplace=True, backup='.bak') as file:
    for line in file:
