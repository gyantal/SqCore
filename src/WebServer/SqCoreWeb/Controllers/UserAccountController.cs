...
public class UserAccountController : Microsoft.AspNetCore.Mvc.Controller
{
    ...
    public async Task<ActionResult> UserInfo()
    {
        ...
        {
            return Content(
                @"<HTML><body>Google Authorization Is Required. You are not logged in or your your Google account is not accepted.<br>" +
                @"<A href=""/logout"">logout this Google user </a> and login with another one.</body></HTML>", "text/html");
        }
