    ...
    public static partial class Utils
    {
        ...
        public static double Covariance(double[] samples1, double[] samples2)
        {
            if (samples1.Length != samples2.Length)
            {
                ...
                throw new Exception("Resources.ArgumentVectorsSameLength");
            }
        ...
        public static double QuantileInplace(double[] data, double tau)
        {
            ...
            // "There is no standard definition of percentile,[2][3][4] however all definitions yield similar results when the number of observations is very large"
