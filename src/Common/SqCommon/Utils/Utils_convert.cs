...
public static partial class Utils
{
    ...
    public static T RoundToDecimalPlace<T>(this decimal numberToTruncate, int decimalPlaces)
    ...
    public static T InvariantConvert<T>(object p_val, bool p_ifNullAllowDefault = false)
        where T : struct // int is struct, if p_val is null, in general we want to raise exception.
    {
    ...
    public static T? InvariantConvertNullableReference<T>(object p_val, bool p_ifNullAllowDefault = false)
        where T : class // string is class, not struct  // if p_val is null, in general we want to raise exception.
    {
        if (p_val == null && p_ifNullAllowDefault)
            return default;
        if (p_val is T t)
