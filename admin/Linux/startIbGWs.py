...
logging.info("***** START IB Gateways *****")
logging.info("Python version: " + python_version())

logging.info("GA GW: starting in a parallel subprocess.");
subprocess.call(['/home/sq-vnc-client/opt/ibc/gwstartGA3.sh'])
logging.info("GA GW: started. Now sleep 100sec (50s may not enough)...")
time.sleep(100)
